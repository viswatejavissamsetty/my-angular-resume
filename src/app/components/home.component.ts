    ...
    <div class="space-y-8" @fadeIn>
      ...
      <section class="text-center py-12 px-4 sm:px-6 lg:px-8" @fadeInUp>
        <div class="flex flex-col items-center space-y-6">
          <div
            class="relative w-48 h-48 rounded-full overflow-hidden border-4 border-gradient-to-r from-cyan-400 to-blue-500 transform hover:scale-105 transition-transform duration-300 shadow-xl"
          >
            <img
              src="/profile.jpeg"
              alt="Viswa Teja"
          ...
          <div>
            <h1
              class="text-4xl font-bold text-primary-500 sm:text-5xl md:text-6xl"
            >
              <span class="font-bold underline">Viswa</span> Teja Vissamsetty
            </h1>
            <p class="mt-3 text-xl text-gray-300">
              Angular Developer at Infosys
            </p>
            <p class="mt-6 text-lg text-gray-400 max-w-3xl mx-auto">
              A passionate developer with expertise in Angular, React, and
              Node.js ecosystems. Currently working with cutting-edge
              technologies and always eager to learn and adapt to new
              challenges.
            </p>
          </div>
        </div>
      ...
      <!-- About Section -->
      <section
        class="bg-gray-800/60 backdrop-blur-md rounded-lg p-6 shadow-lg border border-gray-700/50"
        @fadeInUp
      >
        ...
        <div class="mt-6 space-y-2">
          ...
          <p class="text-gray-300">
            ...
            >
              {{ 'viswatejavissamsetty@gmail.com' }}
            </a>
          </p>
          <p class="text-gray-300">
          ...
          <p class="text-gray-300">
            ...
            <a
              ...
              class="text-gray-300 hover:text-cyan-400"
            >
              Viswa teja Vissamsetty (linkedin.com/in/viswa-teja-vissamsetty)
            </a>
          </p>
        </div>
      </section>
      ...
      <section class="grid grid-cols-1 md:grid-cols-3 gap-6" @fadeInUp>
        <div
          class="bg-gray-800/40 backdrop-blur-sm p-6 rounded-lg shadow-lg border border-gray-700/30 hover:bg-gray-800/60 transition-all duration-300"
        >
